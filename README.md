...
| 날짜 | 문제 | 어려웠던 점 | 🤗 |
| --- |  ---- |--- | --- |
| 8/7 | 💡프로그래머스_L1_없는숫자더하기<br/>💡Solution_Lv1_음양더하기<br/>💡 Solution_Lv1_내적<br/>💡Solution_Lv1_폰켓몬 | 💡0~9까지 합을 45로 설정하고 배열의 값을 빼주는 방법, 배열 인덱스를 굳이 알 필요 없으면 for(i:numbers)로 하기<br/>💡answer += absolutes[i] * (signs[i]? 1: -1);<br/>  -  <br/>💡HashSet |⭕|
